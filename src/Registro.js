...
function Registro() {
    return (
      ...
      <h1 className="text-center container mt-5 mb-3 fw-normal shadow-sm p-3  bg-body rounded">Resgístrese para tener acceso a contactos personalizados</h1>
...
<center><img className="mb-3 " width={"200px"} src="https://cdn-icons-png.flaticon.com/512/9387/9387786.png"/></center>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label  "><h4 className="border-bottom border-dark">Nombre</h4></label>
    <input type="email" class="form-control" id="exampleInputEmail1"  placeholder="Ingrese en este recuadro blanco su nombre (haciendo click aqui)" aria-describedby="emailHelp"/>
  ...
  <center><button type="submit" class="btn btn-primary mt-3 p-4">Haga click aqui para registrarse</button></center>
  </div>
</form>
